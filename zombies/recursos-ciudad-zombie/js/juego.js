...
var Juego = {
    ...
    obstaculosCarretera: [
        ...
        new Obstaculo('imagenes/bache.png', 780, 450, 30, 30, 1),
        new Obstaculo('imagenes/valla_vertical.png', 820, 80, 30, 30, 1),
        new Obstaculo('imagenes/auto_verde_abajo.png', 300, 450, 15, 30, 1),
        new Obstaculo('imagenes/valla_horizontal.png', 100, 200, 30, 30, 1),
        new Obstaculo('imagenes/valla_horizontal.png', 800, 280, 30, 30, 1),
        new Obstaculo('imagenes/auto_verde_abajo.png', 860, 450, 15, 30, 1),
    ...
    enemigos: [
        new ZombieCaminante('imagenes/zombie1.png', 90, 250, 10, 10, 2, { desdeX: 50, hastaX: 150, desdeY: 240, hastaY: 260 }),
        new ZombieCaminante('imagenes/zombie1.png', 120, 550, 10, 10, 1, { desdeX: 50, hastaX: 150, desdeY: 240, hastaY: 260 }),
        new ZombieCaminante('imagenes/zombie4.png', 100, 50, 14, 10, 3, { desdeX: 50, hastaX: 150, desdeY: 240, hastaY: 260 }),
        new ZombieCaminante('imagenes/zombie6.png', 10, 50, 80, 80, 0.5, { desdeX: 10, hastaX: 600, desdeY: 250, hastaY: 460 }),
        new ZombieCaminante('imagenes/zombie5.png', 510, 25, 60, 80, 3, { desdeX: 500, hastaX: 900, desdeY: 180, hastaY: 200 }),
        new ZombieCaminante('imagenes/zombie2.png', 500, 80, 15, 15, 1, { desdeX: 500, hastaX: 950, desdeY: 80, hastaY: 260 }),
        new ZombieCaminante('imagenes/zombie3.png', 20, 150, 15, 15, 6, { desdeX: 20, hastaX: 600, desdeY: 300, hastaY: 260 }),
        new ZombieConductor('imagenes/tren_vertical.png', 644, 0, 30, 90, 4, { desdeX: 0, hastaX: 950, desdeY: 0, hastaY: 577 }, "v"),
        new ZombieConductor('imagenes/tren_vertical.png', 676, 0, 30, 90, 12, { desdeX: 0, hastaX: 950, desdeY: 0, hastaY: 577 }, "v"),
        new ZombieConductor('imagenes/tren_horizontal.png', 400, 324, 90, 30, 8, { desdeX: 0, hastaX: 950, desdeY: 0, hastaY: 577 }, "h")
    ]
}
...
Juego.dibujarFondo = function() {
    ...
    if (this.terminoJuego()) {
        ...
        this.jugador.mover = function() {};
        Juego.capturarMovimiento = function() {};
    ...
    // Si se gano el juego hay que mostrar el mensaje de ganoJuego de fondo
        ...
        Dibujante.dibujarImagen('imagenes/mapa2.jpg', 0, 5, this.anchoCanvas, this.altoCanvas);
    }
};
